# Стан подій та форми | goit-react-hw-04-feedback
...
- Створені репозиторій `goit-react-hw-024-feedback`.
...
!!!Проведено рефакторинг коду завдання «Віджет відгуків» з другого модуля,
використовуючи React-хуки.

Завдання перед рефакторингом:
